...
public class WeeklyTransactionsController implements Initializable {
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public WeeklyTransactionsController() throws SQLException {}

    private String[] choices = {"Show All", "Yearly", "Monthly", "Weekly", "Daily", "Sign Out"};

    public void loadDailyTransactions() {

        for (Transaction transactions : transactionRepository.getWeeklyTransactions()) {
